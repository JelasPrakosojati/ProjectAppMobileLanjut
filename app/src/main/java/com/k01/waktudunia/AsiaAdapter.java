...
public class AsiaAdapter extends RecyclerView.Adapter<AsiaAdapter.ViewHolder> {
    ...
    public AsiaAdapter(Context context, List<Benua> list) {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View v = LayoutInflater.from(context).inflate(R.layout.item_asia, parent, false);
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(@NonNull View itemView) {
            ...
            negara = itemView.findViewById(R.id.negaraasia);
            kota = itemView.findViewById(R.id.kotaasia);
            waktu = itemView.findViewById(R.id.waktuasia);
            box_linear = itemView.findViewById(R.id.box_linear);
            peta = itemView.findViewById(R.id.petaasia);
        }
    }
}
