...
public class EropaAdapter extends RecyclerView.Adapter<EropaAdapter.ViewHolder> {

    private Context context;
    private List<Benua> list;

    public EropaAdapter(Context context, List<Benua> list) {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View v = LayoutInflater.from(context).inflate(R.layout.item_eropa, parent, false);
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(@NonNull View itemView) {
            ...
            negara = itemView.findViewById(R.id.negaraeropa);
            kota = itemView.findViewById(R.id.kotaeropa);
            waktu = itemView.findViewById(R.id.waktueropa);
            box_linear = itemView.findViewById(R.id.box_linear);
            peta = itemView.findViewById(R.id.petaeropa);
        }
    }
}
